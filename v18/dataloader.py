...
style.use('default')  # or any other valid style
...
if __name__ == '__main__':
	...
	image_width  = 128
	batch_size   = 8
	dataloader = DataLoader(NerfDataLoader(jsonPath='nerf_example_data\nerf_synthetic\lego\transforms_train.json', datasetPath='dataset/nerf_synthetic/lego', imageHeight=image_height, imageWidth=image_width), batch_size=batch_size, shuffle=True, num_workers=8, pin_memory=True, drop_last=True)
